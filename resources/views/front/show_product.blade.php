                    ...
                    <div class="s_product_text">
                        ...
                        <h2> @if($product->flag == 1)
                            ...
                            @else
                                ...
                                <h6 class="l-through"><del>{{$product->base_price}} $</del>     </h6>

                            @endif</h2>
                        <ul class="list">
                            <li><a class="active" href="#"><span>Store</span> : {{$product->stores->name}}</a></li>
                        ...
                        <div class="col-lg-6">
                            <div class="comment_list">
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{asset("front/img/product/review-1.jpg")}}" alt="">
                                        </div>
                                ...
                                <div class="review_item reply">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{asset("front/img/product/review-2.jpg")}}" alt="">
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                            <h5>12th Feb, 2018 at 05:56 pm</h5>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{asset("front/img/product/review-3.jpg")}}" alt="">
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                            <h5>12th Feb, 2018 at 05:56 pm</h5>
